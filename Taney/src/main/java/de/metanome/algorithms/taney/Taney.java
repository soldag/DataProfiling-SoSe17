...
public class Taney extends TaneyAlgorithm 				// Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	public String getDescription() {
		return "An FD algorithm returning minimal functional dependencies"; // A string briefly describing what this algorithm does
	}
	...
	public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
		...
		conf.add(new ConfigurationRequirementRelationalInput(Taney.Identifier.INPUT_GENERATOR.name()));
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if (!Taney.Identifier.INPUT_GENERATOR.name().equals(identifier))
			this.handleUnknownConfiguration(identifier, values);
